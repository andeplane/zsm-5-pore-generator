...
//{
//    gradient.deltaXVector().resize(geometry.planesPerDimension());
//    gradient.deltaYVector().resize(geometry.planesPerDimension());
//    gradient.deltaZVector().resize(geometry.planesPerDimension());

//    vector<float> &x = geometry.deltaXVector();
//    vector<float> &y = geometry.deltaYVector();
//    vector<float> &z = geometry.deltaZVector();

//    vector<float> &dEdx = gradient.deltaXVector();
//    vector<float> &dEdy = gradient.deltaYVector();
//    vector<float> &dEdz = gradient.deltaZVector();
